...
interface CardProps {
    ...
    lozengeSlot?: React.ReactNode | React.ReactNode[];
}

const Card: React.FC<CardProps> = ({heading, meta, footerSlot, lozengeSlot, children}) => {
    return (
        <div className="c-card">
            <div className="c-card__lozenge-slot">{lozengeSlot}</div>
